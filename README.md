...
## 📅 Metodologia de estudo (rotina semanal)
...
- Python aplicado para dados  
- Manipulação e limpeza de dados  
- SQL (consultas e modelagem)  
- Estruturação de projetos de dados  
- Fundamentos de pipelines  
- Spark / Databricks *(fase futura)*

### 🔹 Trilha de Machine Learning
- Fundamentos (estatística, métricas, validação)  
- scikit-learn (modelos clássicos e pipelines)  
- Projetos simples evoluindo gradualmente  
- Conceitos iniciais de MLOps
